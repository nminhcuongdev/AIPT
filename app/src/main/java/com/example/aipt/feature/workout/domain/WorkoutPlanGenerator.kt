package com.example.aipt.feature.workout.domain
...
import com.example.aipt.feature.workout.domain.model.BasicProfile
import com.example.aipt.feature.workout.domain.model.BodyComposition
import com.example.aipt.feature.workout.domain.model.EquipmentAvailability
...
import com.example.aipt.feature.workout.domain.model.ProgressionWeek
import com.example.aipt.feature.workout.domain.model.SegmentalMuscleMass
...
import com.example.aipt.feature.workout.domain.model.WorkoutPreferences
...
class WorkoutPlanGenerator @Inject constructor() {
    fun buildRequest(profile: UserProfile, equipment: List<GymEquipment>): WorkoutPlanRequest = WorkoutPlanRequest(
        ...
        segmentalMuscleMass = SegmentalMuscleMass(
            leftArmMuscleKg = profile.leftArmMuscleKg,
            rightArmMuscleKg = profile.rightArmMuscleKg,
            trunkMuscleKg = profile.trunkMuscleKg,
            leftLegMuscleKg = profile.leftLegMuscleKg,
            rightLegMuscleKg = profile.rightLegMuscleKg,
        ),
