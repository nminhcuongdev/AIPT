package com.example.aipt.feature.dashboard.presentation.components
...
import com.example.aipt.feature.dashboard.presentation.TodayDashboardUiState
import com.example.aipt.feature.dashboard.presentation.TodayExerciseUiState
...
@Composable
internal fun TodayDashboardScreen(
...
private fun DashboardContent(
    ...
    AiptHeroHeader(
        ...
        trailing = { StatusPill(state.status) },
    )
...
private fun StatusPill(status: WorkoutSessionStatus) {
    ...
    AiptPill(label, containerColor = color, contentColor = Ink900)
}
...
@Composable
private fun TargetChip(icon: ImageVector, text: String) {
